...
<html>
<head>
<title>Computer Second Semester</title>
	 ...
	 <div style="width:656px;margin-top:20px;margin-left:40px;"><center>
	  <table>
				...
				<form method="POST" action="buyNow.php">
					...
					<input type="hidden" name="publisher" value="Technical Publication">
					<input type="submit" name="submit" value="BuyNow">
				</form></th></tr></table><br><br></center>
	  </div></div>
    </div>
...
<tr>
   <th colspan="2"><marquee>Computer Programming Using C </marquee></th>
</tr>
<tr>  
    <td style="width: 50%">
	<div class ="wrapper">
	 ...
	 <center>
	  <picture>
          <source media="(min-width: 650px)" srcset="images/secSbook/eng9.jpeg">
          <source media="(min-width: 465px)" srcset="images/secSbook/eng9.jpeg">
          <img class="abc" src="images/secSbook/eng9.jpeg"width="300px"height="250">
      </picture>
	  <details>
	  <summary style="margin:6px;">Description
	  </summary><p>Name: Computer Science: A Structured Programming Approach Using C 3rd Edition<br>
                   Price: ₹7658<br>
                   Author: Behrouz A. ForouzanRichard F. Gilberg<br>
	  ...
	  <table>
					<tr><th>
				<form method="POST" action="buyNow.php">
					<input type="hidden" name="img" value="images/secSbook/eng9.jpeg">
					<input type="hidden" name="product" value="A Structured Programming Approach Using C 3rd Edition">
					<input type="hidden" name="author" value="Behrouz A. ForouzanRichard F. Gilberg">
					<input type="hidden" name="price" value="7658">
					<input type="hidden" name="publisher" value="Cengage">
					<input type="submit" name="submit" value="BuyNow">
				</form></th></tr></table><br><br></center>
	  </div></div>
    </div>
	...
	<div class ="wrapper">
	 ...
	 <center>
	  <picture>
          <source media="(min-width: 650px)" srcset="images/secSbook/eng10.jpeg">
          <source media="(min-width: 465px)" srcset="images/secSbook/eng10.jpeg">
          <img class="abc" src="images/secSbook/eng10.jpeg"width="300px"height="250">
      </picture>
	  <details>
	  <summary style="margin:6px;">Description
	  </summary><p>Name:Computer Science a Structured Programming Approach Using C <br>
                   Price: ₹375<br>
                   Author:Forouzan Behrouz A.<br>
                   Publisher: Cengage<br>
				   Pages: 780<br>
				</p>
	  </details></center></div>
	  ...
	  <table>
					<tr><th>
				<form method="POST" action="buyNow.php">
					<input type="hidden" name="img" value="images/secSbook/eng10.jpeg">
					<input type="hidden" name="product" value="Computer Science a Structured Programming Approach Using C">
					<input type="hidden" name="author" value="Forouzan Behrouz A.">
